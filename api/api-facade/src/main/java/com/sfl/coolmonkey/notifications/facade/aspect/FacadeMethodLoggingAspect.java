package com.sfl.coolmonkey.notifications.facade.aspect;
...
public class FacadeMethodLoggingAspect {
    ...
    @Around("execution(public * com.sfl.coolmonkey.notifications.facade..* (..))" +
            " && !execution(* com.sfl.coolmonkey.notifications.facade.helper..* (..))")
