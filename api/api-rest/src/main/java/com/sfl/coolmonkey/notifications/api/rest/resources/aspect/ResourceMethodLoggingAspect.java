package com.sfl.coolmonkey.notifications.api.rest.resources.aspect;
...
public class ResourceMethodLoggingAspect {
    ...
    @Around("execution(public * com.sfl.coolmonkey.notifications.api.rest.resources.*..* (..))")
    ...
    @AfterThrowing(value = "execution(public * com.sfl.coolmonkey.notifications.api.rest.resources.*..* (..))",
            throwing = "e")
